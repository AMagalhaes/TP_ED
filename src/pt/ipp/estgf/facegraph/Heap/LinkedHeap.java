...
public class LinkedHeap<T> extends LinkedBinaryTree<T> implements HeapADT<T> {
    ...
    private HeapNode<T> getNextParentAdd() {
        ...
        if (result != root) {
            if (result.parent.getRigth() == null) {
                result = result.parent;
            } else {
                result = (HeapNode<T>) result.parent.getRigth();
    ...
    private HeapNode<T> getNewLastNode() {
        ...
        while (result.getRigth() != null) {
            result = (HeapNode<T>) result.getRigth();
        }
        return result;
    }
    ...
    private void heapifyRemove() {
        ...
        HeapNode<T> right = (HeapNode<T>) node.getRigth();
        HeapNode<T> next;
        ...
        while ((next != null) && (((Comparable) next.getElement()).compareTo(temp) < 0)) {
            ...
            right = (HeapNode<T>) node.getRigth();
            if ((left == null) && (right == null)) {
                next = null;
            } else if (left == null) {
                next = right;
